...
RUN apt-get -y install nginx uwsgi libpython-dev python2.7-dev libpython2.7-dev libexpat1-dev libc libc-dev uwsgi-plugin-python git python-virtualenv vim python-dev
RUN mkdir /home/web
